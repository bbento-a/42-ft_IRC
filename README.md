...
## Resources
Here are the links for some of the articles / documentation we read from:
- https://datatracker.ietf.org/doc/html/rfc1459 -> Internet Relay Chat Protocol Documentation
...
- And of course, some of our peers from school
